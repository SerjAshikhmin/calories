...
import ru.ashihmin.calories.web.AbstractControllerTest;
...
import static ru.ashihmin.calories.TestUtil.readFromJson;
import static ru.ashihmin.calories.TestUtil.readFromJsonMvcResult;
import static ru.ashihmin.calories.UserTestData.*;
import static ru.ashihmin.calories.model.AbstractBaseEntity.START_SEQ;
import static ru.ashihmin.calories.util.MealsUtil.createTo;
import static ru.ashihmin.calories.util.MealsUtil.getTos;
import static ru.ashihmin.calories.util.exception.ErrorType.VALIDATION_ERROR;
import static ru.ashihmin.calories.web.ExceptionInfoHandler.EXCEPTION_DUPLICATE_DATETIME;
