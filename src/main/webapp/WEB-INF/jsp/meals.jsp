...
<%@ taglib prefix="fn" uri="http://calories.ashihmin.ru/functions" %>

<html>
<jsp:include page="fragments/headTag.jsp"/>
<body>
<script type="text/javascript" src="resources/js/calories.common.js" defer></script>
<script type="text/javascript" src="resources/js/calories.meals.js" defer></script>
